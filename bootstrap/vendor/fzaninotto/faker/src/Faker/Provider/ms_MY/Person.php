...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $firstNameChinese = array(
        ...
        'Fa','Fah','Fai','Fam','Fan','Fang','Fat','Fatt','Fay','Faye','Payment','Fei','Fen','Feng','Fern','Fey','Fok','Fon','Fong','Foo','Foon','Foong','Fu','Fui','Fuk','Fun','Fung',
    ...
    protected static $firstNameMaleChinese = array(
        ...
        'Eu','Ew',
        'Fai','Fam','Fat','Fatt','Payment','Feng','Fok','Fon','Fong','Foo','Foon','Foong','Fu','Fui','Fuk',
